    ...
    <div className="sortlabels">
        ...
        <div className="sortlabels__featuresDiv">
          ...
          <ul className="sortlabels__featuresContainer">
            {features.map((feature: string, index) => {
              return (
                <li className="sortlabels__feature" key={index}>
                  {feature}
                </li>
              );
            })}
      ...
      <div className="sortlabels__mainContent">
        {userStatus == true ? (
          <>
            ...
            <text className="sortlabels__descriptionText">
              Crop and sort {type} PDF Labels in the order you want with the
              easiest {type} Label Crop tool available.
            </text>
            <Upload
              onUploadCompletion={handleUploadCompletion}
              platform={type ? type.toLowerCase() : ""}
            />
          </>
        ) : (
          <>
      ...
      <div className="sortlabels__rightContent">
        <div className="sortlabels__columnFlex">
          {showFileName ? (
            <text className="sortlabels__durationText">
              {" "}
              Your Files<br></br>(last 30 mins.){" "}
            </text>
          ) : (
          ...
          <ul className="sortlabels__filesList">
            {fileData &&
              ...
              fileData.data.map((fileName: string | String, index: number) => {
                return (
                  <li className="sortlabels__fileItem" key={index}>
                    ...
                    >
                      {`${fileName.split("_")[2]?.slice(-4) || ""}_merged_${
