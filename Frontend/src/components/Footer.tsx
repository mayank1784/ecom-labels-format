          ...
          <div className="footer-content">
            <div className="footer-content-column">
              <div className="footer-logo">
                  ...
                  <h1 onClick={() => { navigate("/") }}>Label Sorters</h1>
              ...
              <div className="footer-menu">
                ...
                <ul id="menu-quick-links" className="footer-menu-list">
                  <li className="menu-item menu-item-type-custom menu-item-object-custom">
                    <a target="_blank" rel="noopener noreferrer" href="/sortlabels/Amazon">Amazon</a>
                  </li>
                  <li className="menu-item menu-item-type-custom menu-item-object-custom">
                    <a target="_blank" rel="noopener noreferrer" href="/sortlabels/Flipkart">Flipkart</a>
                  </li>
                  <li className="menu-item menu-item-type-post_type menu-item-object-page">
                  <a target="_blank" rel="noopener noreferrer" href="/sortlabels/Meesho">Meesho</a>
                  </li>
                  {/* <li className="menu-item menu-item-type-post_type menu-item-object-page">
                    <a href="#">Blog</a>
                  </li>
            ...
            <div className="footer-content-column">
              ...
              <div className="footer-call-to-action">
                <h2 className="footer-call-to-action-title"> Write to us</h2>
                <p className="footer-call-to-action-link-wrapper"> <a className="footer-call-to-action-link" href="mailto: support@labelsorters.com" target="_blank">support@labelsorters.com</a></p>
              </div>
            </div>
          ...
          <div className="footer-copyright">
            <div className="footer-copyright-wrapper">
              <p className="footer-copyright-text">
                <a className="footer-copyright-link" href="#" target="_self"> © {new Date().getFullYear()} | Label Sorters | All rights reserved. </a>
              </p>
            </div>
          </div>
        </footer>
